    ...
    <div className="text-white min-h-screen">
      ...
      <section className="max-w-7xl mx-auto px-6 py-16 md:py-24 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-7 flex flex-col justify-center text-center lg:text-left anim-fade-up">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-purple-500/20 bg-purple-950/10 text-purple-300 text-xs font-semibold w-fit mx-auto lg:mx-0 mb-6">
            🎉 A 100% direct-to-creator platform
          </div>

          <h1 className="text-5xl md:text-6xl font-bold font-serif leading-tight tracking-tight">
            Fund your creative journey, <br className="hidden md:inline" />
            one <span className="bg-gradient-to-r from-purple-400 via-fuchsia-500 to-pink-500 bg-clip-text text-transparent">Chai</span> at a time.
          </h1>
          ...
          <form onSubmit={handleClaim} className="mt-8 max-w-lg mx-auto lg:mx-0">
            <div className="relative flex items-center p-1.5 rounded-2xl border border-purple-900/30 bg-black/60 backdrop-blur-md focus-within:border-purple-500/60 focus-within:ring-4 focus-within:ring-purple-500/10 transition-all duration-300">
              ...
              <button
                type="submit"
                disabled={claimed}
                className="bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white px-6 py-3 rounded-xl font-bold text-sm transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] cursor-pointer shrink-0 shadow-lg shadow-purple-500/10 flex items-center gap-2"
              >
                {claimed ? (
                  <>
        ...
        <div className="lg:col-span-5 flex justify-center items-center anim-fade-up anim-delay-1 select-none">
          <div className="w-full max-w-sm rounded-3xl border border-purple-500/20 bg-[#0c0512]/90 p-5 shadow-[0_0_50px_rgba(139,92,246,0.15)] relative overflow-hidden backdrop-blur-md">
            
            {/* Mock Profile Card Cover Banner */}
            <div className="h-24 w-full rounded-2xl bg-gradient-to-tr from-indigo-900/60 to-purple-800/40 relative overflow-hidden border border-white/5">
              <div className="absolute top-3 right-3 px-2 py-0.5 rounded bg-black/40 text-[10px] border border-white/10 tracking-widest uppercase font-mono text-purple-300">
                LIVE PREVIEW
              </div>
            </div>
            ...
            <div className="relative px-3 -mt-10 flex flex-col items-center text-center">
              <img
                ...
                alt="Aditya"
                className="w-20 h-20 rounded-full border-4 border-[#0c0512] object-cover ring-2 ring-purple-500/30"
              />
              ...
              <p className="text-xs text-purple-300/80 font-medium">Building open-source Next.js frameworks</p>
            </div>
            ...
            <div className="mt-5 px-1">
              <div className="flex justify-between text-[11px] font-semibold text-gray-400 mb-1">
                ...
                <span className="text-purple-400">80% funded</span>
              </div>
              <div className="h-2 w-full rounded-full bg-white/5 overflow-hidden border border-white/5">
                <div className="h-full bg-gradient-to-r from-purple-500 to-indigo-500 rounded-full" style={{ width: "80%" }} />
              </div>
            </div>
            ...
            <div className="mt-5 p-4 rounded-2xl bg-white/[0.02] border border-white/5 text-center">
                  ...
                  <button
                    ...
                    className={`py-2 px-1 rounded-xl text-xs font-bold transition-all duration-200 border cursor-pointer ${
                      selectedChais === val
                        ...
                        : "bg-black/30 border-white/5 text-gray-400 hover:border-purple-500/30"
                    }`}
                  >
                    ☕ {val} Chai{val > 1 ? "s" : ""}
                  </button>
              ...
              <button 
                type="button"
                className="mt-4 w-full py-2.5 rounded-xl bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white font-bold text-xs transition-all hover:scale-[1.02] active:scale-[0.98] cursor-pointer"
              >
            ...
            <div className="mt-4 space-y-2">
              <div className="flex gap-2.5 items-start p-2 rounded-xl bg-white/[0.01] border border-white/5">
                <div className="w-6 h-6 rounded-full bg-indigo-900/40 border border-white/10 flex items-center justify-center text-[10px] font-bold text-indigo-300">S</div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        <div className="h-px bg-gradient-to-r from-transparent via-purple-500/20 to-transparent mb-16" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-2 lg:order-1 flex justify-center">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
              ...
              <div className="border border-white/10 bg-purple-950/5 p-6 rounded-2xl flex flex-col gap-3">
                <div className="w-10 h-10 rounded-xl bg-purple-900/40 border border-purple-500/20 flex items-center justify-center text-xl">
                  💎
                </div>
                <h3 className="text-lg font-bold text-purple-400">0% Platform Fee</h3>
              ...
              <div className="border border-white/10 bg-purple-950/5 p-6 rounded-2xl flex flex-col gap-3">
                ...
                <h3 className="text-lg font-bold text-purple-400">Real-time Payouts</h3>
                <p className="text-gray-400 text-sm leading-relaxed">
          ...
          <div className="order-1 lg:order-2 flex flex-col justify-center text-center lg:text-left">
            ...
            <div className="mt-6 flex justify-center lg:justify-start">
              <Link href="/signup" className="text-sm font-semibold text-purple-400 hover:text-purple-300 flex items-center gap-1.5 transition-colors cursor-pointer">
      ...
      <section className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="border border-white/5 bg-[#111]/40 rounded-2xl p-6 relative">
            <div className="absolute top-4 right-4 text-4xl font-extrabold font-mono text-purple-500/10 select-none">01</div>
          ...
          <div className="border border-white/5 bg-[#111]/40 rounded-2xl p-6 relative">
            <div className="absolute top-4 right-4 text-4xl font-extrabold font-mono text-purple-500/10 select-none">02</div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            <div key={i} className="bg-[#0f0717]/60 border border-purple-500/10 rounded-2xl p-5 group hover:border-purple-500/30 hover:shadow-lg hover:shadow-purple-500/5 transition-all duration-300 flex flex-col justify-between">
              <div>
                <div className="flex items-center gap-3">
                  <img
                    src={creator.avatar}
                    alt={creator.name}
                    className="w-12 h-12 rounded-full object-cover ring-2 ring-purple-500/20 transition-transform duration-300 group-hover:scale-105"
                  />
                  <div>
                    <h3 className="text-white font-bold text-sm group-hover:text-purple-300 transition-colors">{creator.name}</h3>
                    <span className="text-[10px] font-bold font-mono px-2 py-0.5 rounded bg-purple-500/10 text-purple-300 block w-fit mt-0.5">
                ...
                <div className="mt-4">
                  ...
                  <div className="h-1.5 w-full rounded-full bg-white/5 overflow-hidden">
                    <div className="h-full bg-purple-500/60 rounded-full" style={{ width: `${creator.progress}%` }} />
                  </div>
                </div>
              </div>
              ...
              <Link
                ...
                className="mt-5 w-full py-2 bg-purple-950/20 border border-purple-500/20 hover:border-purple-500/50 hover:bg-purple-600 text-white rounded-xl text-xs font-bold text-center block transition-all duration-200 cursor-pointer"
              >
                Support Creator
              </Link>
            </div>

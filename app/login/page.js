    ...
    try {
      ...
      if (res?.error) {
        if (res.error === "2FA_REQUIRED") {
          // Trigger OTP request & call API to send OTP via email
          const triggerRes = await fetch("/api/auth/2fa/send-otp", {
            method: "POST",
          ...
          if (triggerRes.ok) {
            ...
            setError(triggerData.error || "Failed to initialize 2FA verification");
          }
        } else {
          setError(res.error);
        }
              ...
              <>
                <div className="text-center space-y-2 mb-4">
                  ...
                  <p className="text-xs text-gray-400">
                    We sent a 6-digit verification code to <span className="text-white font-medium">{email}</span>. Please enter it below.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="123456"
                    className="w-full rounded-lg border border-slate-800 bg-[#090a0f] px-4 py-3 text-center text-xl font-bold tracking-widest text-white placeholder-gray-600 outline-none transition duration-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20"
                  />
                </div>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full rounded-lg bg-blue-600 px-4 py-3 font-semibold text-white transition-all duration-200 hover:bg-blue-700 hover:scale-[1.02] active:scale-[0.98] shadow-lg shadow-blue-500/10 disabled:opacity-50"
                >
